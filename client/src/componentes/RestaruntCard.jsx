...
const RestaurantCard = (props) => {
    ...
    return <Link to={`/restaurant/${props._id}/overview`} >
        <div className='bg-white p-4  w-full rounded-2xl transtion duration-700 ease-in-out sm:shadow-md md:shadow-none  hover:drop-shadow-lg ' >
            <div className='w-full relative' >
                ...
                <div className='my-2 flex flex-col gap-2' >
                    ...
                    <div className='flex items-center justify-between text-gray-500 gap-10 w-3/4' >
                        <p className='truncate text-ellipsis overflow-hidden' >{props.cuisine.join(",")}</p>
                        <p className='w-3/4' >₹{props.averageCost} for one</p>
                    </div>
                </div>
            </div>
        </div>
