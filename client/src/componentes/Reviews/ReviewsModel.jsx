                  ...
                  <div className="mt-2 flex flex-col gap-4">
                    ...
                    <form className="flex flex-col gap-4">
                      <div className="w-full flex flex-col gap-2">
                        ...
                        <input type="text" id="subject" placeholder="Add context..." value={reviewData.subject}
                          onChange={handleChange}
                          className="w-full border border-gray-400 px-3 py-2 rounded-lg focus:outline focus:border-r-zomato-400"
                        />
                      </div>
                      <div className="w-full flex flex-col gap-2">
                        <label htmlFor="reviewText">Comment</label>
                        <textarea type="text" id="reviewText" rows={5} placeholder="Add review..." value={reviewData.reviewText}
                          onChange={handleChange}
                          className="w-full border border-gray-400 px-3 py-2 rounded-lg focus:outline focus:border-r-zomato-400"
                        />
                      </div>
