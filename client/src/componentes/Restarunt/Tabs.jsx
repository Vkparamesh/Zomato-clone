...
const Tab = (props) => {
    ...
    return <Link to={`/restaurant/${id}/${props.route}`} className="relative">
...
const Tabs = () => {
    ...
    return <div className=' flex relative items-center pb-4 gap-8 md:gap-20 overflow-x-scroll lg:overflow-auto border-b-2'>
