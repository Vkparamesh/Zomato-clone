...
const ImageGrid = (props) => {
  return <>
    <div className='w-full h-60 md:hidden' >
      <img src={props.images.length && props.image[0].location} alt="restaurant"
    ...
    <div className='hidden w-full h-96 md:flex gap-1'>
      ...
      <div className='w-1/4 h-full flex flex-col gap-1  overflow-hidden'>
        <div className='w-full h-2/4  overflow-hidden rounded-lg'>
          <img src={props.images.length && props.image[1].location} alt="restaurant"
            className='w-full h-full object-cover object-center rounded-lg transition duration-700 hover:scale-110'
          />
        </div>
        <div className='w-full h-2/4  overflow-hidden rounded-lg'>
          <img src={props.images.length && props.image[2].location} alt="restaurant"
            className='w-full h-full object-cover object-center rounded-lg transition duration-700 hover:scale-110'
          />
        </div>
      </div>
      <div className='w-1/4 h-full flex flex-col gap-1 overflow-hidden'>
        <div className='w-full h-2/4 relative'>
          <img src={props.images.length && props.image[3].location} alt="restaurant"
            className='w-full h-full object-cover object-center rounded-lg transition '
          />
        ...
        <div className='w-full h-2/4 relative'>
          <img src={props.images.length && props.image[4].location} alt="restaurant"
            className='w-full h-full object-cover object-center rounded-lg transition '
          />
          <div className='absolute inset-0 bg-opacity-40 bg-black h-full rounded-lg ' />
